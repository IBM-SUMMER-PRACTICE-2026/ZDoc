/*
 ...
 documentation-model schema html_model.c consumes. Not a general-purpose
 JSON library; internal to the renderer, not part of its public API
 (see html_model.h for that).
 */
#ifndef ZDOC_HTML_RENDERER_JSON_H
#define ZDOC_HTML_RENDERER_JSON_H
...
#endif /* ZDOC_HTML_RENDERER_JSON_H */
